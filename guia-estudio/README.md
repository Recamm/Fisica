...
Empezá por [00-cronograma.md](00-cronograma.md): ahí está el plan hora por hora y el resumen del hallazgo clave (cómo es realmente el parcial).

## Índice
1. [00-cronograma.md](00-cronograma.md) — plan de estudio para 2 días
2. [01-formulario.md](01-formulario.md) — todas las fórmulas en un solo lugar
3. [02-unidad-vectores-medicion.md](02-unidad-vectores-medicion.md) — Medición (repaso corto) + Vectores: resumen + ejercicios resueltos
4. [03-unidad-estatica.md](03-unidad-estatica.md) — Estática: resumen + ejercicios resueltos
5. [04-unidad-hidrostatica.md](04-unidad-hidrostatica.md) — Hidrostática: resumen + ejercicios resueltos
6. [05-unidad-cinematica.md](05-unidad-cinematica.md) — Cinemática en una dimensión: resumen + ejercicios resueltos
7. [06-banco-ejercicios-parciales.md](06-banco-ejercicios-parciales.md) — ejercicios reales de parciales para practicar
8. [07-simulacro-final.md](07-simulacro-final.md) — simulacro cronometrado tipo examen
...
9. [08-teoria-vectores-medicion.md](08-teoria-vectores-medicion.md) — explicación extensa de Medición y Vectores
10. [09-teoria-estatica.md](09-teoria-estatica.md) — explicación extensa de Estática
11. [10-teoria-hidrostatica.md](10-teoria-hidrostatica.md) — explicación extensa de Hidrostática
12. [11-teoria-cinematica.md](11-teoria-cinematica.md) — explicación extensa de Cinemática en una dimensión
...
Esta comparación es la que definió las prioridades del [00-cronograma.md](00-cronograma.md) (más tiempo a Hidrostática y Estática, que suman más puntos) y el contenido del [06-banco-ejercicios-parciales.md](06-banco-ejercicios-parciales.md) y el [07-simulacro-final.md](07-simulacro-final.md), armados a partir de estos mismos patrones reales.
